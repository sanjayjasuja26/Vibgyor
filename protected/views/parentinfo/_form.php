...
?>
		 ...
		 <?php echo $form->field($model, 'profession')->textInput() ?>
		 ...
		 <?php echo $form->field($model, 'child_name')->textInput(['maxlength' => 255]) ?>
	   ...
	   <div class="form-group">
        ...
        <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['id'=> 'parentinfo-form-submit','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
	</div>
