...
/**
* This is the model class for table "tbl_course_offerd_by_college".
*
    * @property integer $id
...
public static function getUserOptions()
	...
	*/
	...
	{
		return '{{%course_offerd_by_college}}';
	}
	...
	*/
	...
	{
		return [
            [['user_id', 'course_id', 'state_id', 'created_on', 'created_by_id'], 'required'],
            [['user_id', 'course_id', 'state_id', 'type_id', 'created_by_id'], 'integer'],
