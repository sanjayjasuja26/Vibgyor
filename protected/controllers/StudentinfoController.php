...
use app\models\search\Studentinfo as StudentinfoSearch;
 ...
 */
class StudentinfoController extends SController {
    ...
    public function actionAdd() {
        ...
        $model->state_id = Studentinfo::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Studentinfo model.
    ...
    public function actionClear($truncate = true) {
        ...
        \Yii::$app->session->setFlash('success', 'Studentinfo Cleared !!!');
