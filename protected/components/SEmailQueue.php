...
class SEmailQueue extends \app\components\SActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [
                ...
                'in',
                'range' => array_keys(SEmailQueue::getStateOptions())
            ],
            [
                [
                    'attempts',
    ...
    public function beforeValidate() {
        if ($this->isNewRecord) {
            ...
            if (!isset($this->state_id))
                $this->state_id = SEmailQueue::STATE_PENDING;
        }
        return parent::beforeValidate();
    }

    public function geSMailer() {
